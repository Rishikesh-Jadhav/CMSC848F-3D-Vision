...
# CMSC848F Assignment 3 : Volume Rendering and Neural Radiance Fields
# Author: Rishikesh Jadhav (119256534)
===================================

## NOTE: The following folders contain the visualization results:
Assignment3_webpage_write_up/images - contains all the images and gifs for the tasks provided below 

## NOTE: To replicate the results in the package, follow the following steps(as I did the same) and for training in this assignment I used the cluster. 
