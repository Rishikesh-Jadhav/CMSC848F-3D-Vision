...
# Preprocess input data based on the chosen data type
...
# Calculate loss based on the chosen data type
...
# Prepare the dataset and initialize the model for training
def train_model(args):
    ...
    for step in range(start_iter, args.max_iter):
        ...
        if (step % args.save_freq) == args.save_freq-1:
            torch.save({
                'step': step,
    ...
    plt.savefig(f'loss_{args.type}_{args.max_iter}.png') # saves the loss plots for the models
