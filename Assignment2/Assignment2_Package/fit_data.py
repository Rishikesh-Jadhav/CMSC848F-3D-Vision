...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        render_voxel(voxels_src, output_path='fitting_voxel/q_1-1-src.gif')
        render_voxel(voxels_tgt, output_path='fitting_voxel/q_1-1-tgt.gif')
        ...
        render_point_cloud(pointclouds_src, output_path='fitting_point/q_1-2-src.gif')
        render_point_cloud(pointclouds_tgt, output_path='fitting_point/q_1-2-tgt.gif')  
        ...
        render_mesh(mesh_src, output_path='fitting_mesh/q_1-3-src.gif')
        render_mesh(mesh_tgt, output_path='fitting_mesh/q_1-3-tgt.gif')
